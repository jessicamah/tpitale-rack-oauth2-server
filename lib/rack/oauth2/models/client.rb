  ...
  module OAuth2
    class Server
      ...
      class Client < ActiveRecord::Base
        has_many :auth_requests, :dependent => :destroy, :class_name => 'Rack::OAuth2::Server::AuthRequest'
        has_many :access_grants, :dependent => :destroy, :class_name => 'Rack::OAuth2::Server::AccessGrant'
        has_many :access_tokens, :dependent => :destroy, :class_name => 'Rack::OAuth2::Server::AccessToken'
